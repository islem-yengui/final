...
const About = () => {
  return (
    <div>
      <div className="about">
        Forerunner of modern cosmetics for you
        <br />
        QUALITY FOCUSED. INNOVATIVE. CLOSE TO THE CUSTOMER
      </div>
      <img
        style={{
          marginBottom: "3%",
      ...
      <div>
        <p className="test2">
          {" "}
          At Champeca, we develop innovative concepts with a flair for the right
